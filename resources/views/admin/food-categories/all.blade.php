                            ...
                            <tbody>
                                @foreach($categories as $category)
                                    <tr>
                                        ...
                                        <td>{{ $category->title }} {{ $category->lname }}</td>
                                        <td>{{ date('m/d/Y', strtotime($category->updated_at)) }}</td>
                                        <td><a href="/admin/food-categories/{{ $category->id }}/edit">
                                        ...
                                        <td>
                                            ...
                                            <form id="delete-category-{{ $category->id }}" action="/admin/food-categories/{{ $category->id }}/delete"
